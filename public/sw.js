const CACHE_NAME = 'uwu-clock-v3';
const STATIC_CACHE = 'uwu-clock-static-v3';
const DYNAMIC_CACHE = 'uwu-clock-dynamic-v3';
...
self.addEventListener('fetch', (event) => {
  ...
  if (url.pathname.includes('/@vite/') || url.pathname.includes('/@fs/') || url.searchParams.has('import')) {
    return;
  }
